...
function __double_quote_string__(l){
    let pk1 = l.copy();;
...
function __single_quote_string__(l){
    let pk1 = l.copy();;
...
function reset(mark,origin,advanced,pass){
    if(!FAILED&&pass){
        return false;
    }
    action_ptr = mark;
...
function add_reduce(sym_len,body,DNP = false){
...
function soft_fail(l){
    FAILED = true;
    set_error(l.off);
}
function assertSuccess(l,condition){
    if(!condition||FAILED){
        return fail(l);
    }
    return true;
...
function assert_consume(l,accept){
    if(FAILED){
        return false;
    }
    if(accept){
...
function $imported_default_binding(l){
    if($identifier(l)){
        add_reduce(1,17);
        add_reduce(1,9);
        prod = 8;
...
function $named_imports_HC_listbody1_101(l){
...
function $export_clause_HC_listbody1_102(l){
...
function $statement_list_item(l){
...
function $breakable_statement(l){
...
function $expression_statement(l){
    if($expression(l)){
        skip_fn_000(l/*[ ws ]*/);
        if(assert_consume(l,__asi__(l))){
            add_reduce(2,30);
...
function $if_statement_group_163_103(l){
...
function $iteration_statement_group_168_104(l){
...
function $iteration_statement_group_073_105(l){
    if(assert_consume(l,cp27956077_(l)/*[var]*/)){
        /*consume*/
        /*
...
function $iteration_statement(l){
...
function $variable_declaration_list(l){
...
function $variable_declaration(l){
    if(assert_table(l,0x0,0x0,0x8000000,0x8000000)/*tbl:[ [ ] [ { ]*/){
        /*assert-production-closure*/
        /*
...
function $lexical_declaration(l){
    if($let_or_const(l)){
        skip_fn_(l/*[ ws ][ nl ]*/);
        if($binding_list(l)){
            skip_fn_000(l/*[ ws ]*/);
...
function $function_declaration_group_0115_109(l){
    if(assert_consume(l,l.utf==42/*[asterisk]*/)){
        /*consume*/
        /*
...
function $function_declaration(l){
    if(cp87f20bb1_(l)/*[function]*/){
        /*peek*/
        /*
...
function $function_expression(l){
    if(cp87f20bb1_(l)/*[function]*/){
        /*peek*/
        /*
...
function $unique_formal_parameters(l){
    if($formal_parameters(l)){
        prod = 69;
    }
    return assertSuccess(l,prod==69);
}
function $formal_parameters(l){
    if(cp7fa4386a_(l)/*[...]*/){
        /*assert-production-closure*/
        /*
...
function $formal_parameter_list(l){
...
function $function_statement_list(l){
    if((((cp0ac89158_(l)/*[+] [++]*/||cpfaa7aa14_(l)/*[-] [--]*/)||assert_table(l,0x0,0x8008196,0x88000000,0x48000001)/*tbl:[ { ] [ ( ] [ $ ] [ _ ] [ " ] [ ' ] [ [ ] [ / ] [ ` ] [ ~ ] [ ! ] [ ; ]*/)||l.isID()/*[id]*/)||l.isNum()/*[num]*/){
        /*assert-production-closure*/
        /*
...
function $property_set_parameter_list(l){
    if($binding_element(l)){
        prod = 88;
    }
...
function $left_hand_side_expression(l){
...
function $argument_list_group_1182_111(l){
...
function $assignment_expression(l){
...
function $assignment_operator(l){
    if(assert_consume(l,l.utf==42/*[asterisk]*/)){
        /*consume*/
        /*
...
function $conditional_expression(l){
...
function $short_circuit_expression(l){
...
function $logical_and_expression(l){
    if($bitwise_or_expression(l)){
        prod = 113;
    }
    while(prod==113){
...
function $bitwise_or_expression(l){
    if($bitwise_xor_expression(l)){
        prod = 117;
    }
    while(prod==117){
...
function $bitwise_xor_expression(l){
    if($bitwise_and_expression(l)){
        prod = 118;
    }
    while(prod==118){
...
function $bitwise_and_expression(l){
    if($equality_expression(l)){
        prod = 119;
    }
    while(prod==119){
...
function $equality_expression(l){
    if($relational_expression(l)){
        prod = 120;
    }
    while(prod==120){
...
function $relational_expression(l){
    if($shift_expression(l)){
        prod = 121;
    }
    while(prod==121){
...
function $additive_expression(l){
    if($multiplicative_expression(l)){
        prod = 123;
    }
    while(prod==123){
...
function $multiplicative_expression(l){
    if($exponentiation_expression(l)){
        prod = 124;
    }
    while(prod==124){
...
function $exponentiation_expression(l){
    if($unary_expression(l)){
        /*assert*/
        /*
           378 exponentiation_expression=>• unary_expression 
...
function $cover_parenthesized_expression_and_arrow_parameter_list_group_1282_114(l){
    if(assert_consume(l,cp7fa4386a_(l)/*[...]*/)){
        /*consume*/
        /*
...
function $cover_parenthesized_expression_and_arrow_parameter_list_group_1284_115(l){
    if(assert_consume(l,cp7fa4386a_(l)/*[...]*/)){
        /*consume*/
        /*
...
function $cover_parenthesized_expression_and_arrow_parameter_list(l){
    if(l.utf==40/*[(]*/){
        /*peek*/
        /*
           396 cover_parenthesized_expression_and_arrow_parameter_list=>• ( ) 
...
function $object_binding_pattern(l){
    if(assert_consume(l,l.utf==123/*[{]*/)){
        /*consume*/
        /*
...
function $array_binding_pattern(l){
    if(assert_consume(l,l.utf==91/*[[]*/)){
        /*consume*/
        /*
...
function $binding_rest_property(l){
    if(assert_consume(l,cp7fa4386a_(l)/*[...]*/)){
        /*consume*/
        /*
...
function $binding_property_list(l){
...
function $binding_element_list(l){
...
function $binding_elision_element(l){
    if(l.utf==44/*[,]*/){
        /*assert-production-closure*/
        /*
...
function $single_name_binding(l){
    if($binding_identifier(l)){
        /*assert*/
        /*
           432 single_name_binding=>• binding_identifier initializer 
...
function $binding_rest_element(l){
    if(assert_consume(l,cp7fa4386a_(l)/*[...]*/)){
        /*consume*/
        /*
...
function $regular_expression_literal(l){
...
function $property_definition_list(l){
...
function $property_definition(l){
    if(assert_consume(l,cp7fa4386a_(l)/*[...]*/)){
        /*consume*/
        /*
...
function $literal_property_name(l){
    if(l.isNum()/*[num]*/){
        /*assert-production-closure*/
        /*
...
function $computed_property_name(l){
    if(assert_consume(l,l.utf==91/*[[]*/)){
        /*consume*/
        /*
           454 computed_property_name=>[ • assignment_expression ] 
...
function $no_substitute_template(l){
    if(assert_consume(l,l.utf==96/*[`]*/)){
        /*consume*/
        /*
           475 no_substitute_template=>` • ` 
...
function $substitute_template(l){
    if($template_head(l)){
        skip_fn_(l/*[ ws ][ nl ]*/);
        if($expression(l)){
            skip_fn_(l/*[ ws ][ nl ]*/);
...
function $template_middle_list(l){
...
function $future_reserved_word(l){
...
function $composite_identifier(l){
