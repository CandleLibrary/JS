        ...
        const unsigned int action_array_offset = 382976;
const unsigned int error_array_offset = 4577280;
const unsigned int TokenSpace = 1;
const unsigned int TokenNumber = 2;
const unsigned int TokenIdentifier = 4;
const unsigned int TokenNewLine = 8;
const unsigned int TokenSymbol = 16;
const unsigned short id = 2;
const unsigned short num = 4;
unsigned int mark_ = 0;
unsigned int action_ptr = 0;
unsigned int error_ptr = 0;
unsigned int stack_ptr = 0;
bool FAILED = false;
int prod = -1;
unsigned int probe_index = 1;
string str;
unsigned int getTypeAt(unsigned int code_point){
...
public:
    ...
    Lexer copy(Lexer& destination = new  Lexer()){
         destination. utf =  utf;
         destination. ty =  ty;
         destination. tl =  tl;
         destination. off =  off;
         destination. prev_off =  prev_off;
        return  destination;
    }
    void sync(Lexer marker = new  Lexer()){
         marker. copy(this);
    }
    boolean isSym(){
        return  ty== TokenSymbol;
    }
    boolean isNL(){
        return  ty== TokenNewLine;
    }
    boolean isSP(){
        return  ty== TokenSpace;
    }
    boolean isNum(){
        if( ty== TokenNumber){
             consumeNumeric();
    ...
    boolean isID(){
        if( ty== TokenIdentifier){
             consumeIdentifier();
            return true;
        }
        return false;
    }
    boolean typeIs(int flag){
        return ( ty& flag)== ty;
    }
    void consumeNumeric(){
    ...
    u32 getUTF(int delta = 0){
        return  str. codePointAt( off+delta);
    }
    u32 getOffsetRegionDelta(){
        return  off- prev_off;
    }
    void advanceOffsetRegion(){
         prev_off =  off+ tl;
    }
    void syncOffsetRegion(){
         prev_off =  off;
    }
    i32 typeAt(int offset = 0){
         offset =  off+offset;
...
bool __double_quote_string__(Lexer l){
    Lexer pk1 =  l. copy();;
...
bool __single_quote_string__(Lexer l){
    Lexer pk1 =  l. copy();;
...
void set_error(unsigned int val){
    if( error_ptr>=40980){
        return;
    }
     store(( error_ptr++<<2)+ error_array_offset, val);
}
void set_action(unsigned int val){
...
boolean assert_table(Lexer l,unsigned int a,unsigned int b,unsigned int c,unsigned int d){
    const int utf =  l. utf;
    if(utf<32){
        return (a&(1<<utf))!=0;
    } else if(utf<64){
...
boolean reset(unsigned int mark,Lexer origin,Lexer advanced,boolean pass){
    if(! FAILED&&pass){
        return false;
    }
     action_ptr =  mark;
...
void add_shift(const Lexer& l,const unsigned int char_len){
    const unsigned int skip_delta =  l. getOffsetRegionDelta();
    unsigned int has_skip =  skip_delta>0;
    unsigned int has_len =  char_len>0;
    unsigned int val = 1;
     val|=( skip_delta<<3);
...
void add_reduce(unsigned int sym_len,unsigned int body,bool DNP =  false){
...
void soft_fail(Lexer& l){
     FAILED =  true;
     set_error( l. off);
}
bool assertSuccess(Lexer& l,bool condition){
    if(!condition|| FAILED){
        return  fail( l);
    }
    return true;
...
void consume_empty(Lexer& l){
     add_shift( l,0);
}
bool assert_consume(Lexer& l,bool accept){
    if( FAILED){
        return false;
    }
    if( accept){
...
void reset_counters_and_pointers(){
     prod = -1;
     stack_ptr = 0;
     error_ptr = 0;
     action_ptr = 0;
...
bool $import_declaration(Lexer l){
...
bool $imported_default_binding(Lexer l){
    if( $identifier( l)){
         add_reduce(1,17);
         add_reduce(1,9);
         prod = 8;
...
bool $name_space_import(Lexer l){
...
bool $named_imports_HC_listbody1_101(Lexer l){
...
bool $export_declaration(Lexer l){
...
bool $export_clause_HC_listbody1_102(Lexer l){
...
bool $statement_list_item(Lexer l){
...
bool $breakable_statement(Lexer l){
...
bool $expression_statement(Lexer l){
    if( $expression( l)){
         skip_fn_000( l/*[ ws ]*/);
        if( assert_consume( l,__asi__( l))){
             add_reduce(2,30);
...
bool $if_statement_group_163_103(Lexer l){
...
bool $iteration_statement_group_168_104(Lexer l){
...
bool $iteration_statement_group_073_105(Lexer l){
    if( assert_consume( l, cp27956077_( l)/*[var]*/)){
        /*consume*/
        /*
...
bool $iteration_statement(Lexer l){
...
bool $continue_statement(Lexer l){
...
bool $debugger_statement(Lexer l){
...
bool $variable_statement(Lexer l){
    if( assert_consume( l, cp27956077_( l)/*[var]*/)){
        /*consume*/
        /*
...
bool $variable_declaration_list(Lexer l){
...
bool $variable_declaration(Lexer l){
    if( assert_table( l, 0x0, 0x0, 0x8000000, 0x8000000)/*tbl:[ [ ] [ { ]*/){
        /*assert-production-closure*/
        /*
...
bool $lexical_declaration(Lexer l){
    if( $let_or_const( l)){
         skip_fn_( l/*[ ws ][ nl ]*/);
        if( $binding_list( l)){
             skip_fn_000( l/*[ ws ]*/);
...
bool $function_declaration_group_0115_109(Lexer l){
    if( assert_consume( l, l. utf==42/*[asterisk]*/)){
        /*consume*/
        /*
...
bool $function_declaration(Lexer l){
    if( cp87f20bb1_( l)/*[function]*/){
        /*peek*/
        /*
...
bool $function_expression(Lexer l){
    if( cp87f20bb1_( l)/*[function]*/){
        /*peek*/
        /*
...
bool $unique_formal_parameters(Lexer l){
    if( $formal_parameters( l)){
         prod = 69;
    }
     ;
...
bool $formal_parameters(Lexer l){
    if( cp7fa4386a_( l)/*[...]*/){
        /*assert-production-closure*/
        /*
...
bool $formal_parameter_list(Lexer l){
...
bool $function_statement_list(Lexer l){
    if(((( cp0ac89158_( l)/*[+] [++]*/|| cpfaa7aa14_( l)/*[-] [--]*/)|| assert_table( l, 0x0, 0x8008196, 0x88000000, 0x48000001)/*tbl:[ { ] [ ( ] [ $ ] [ _ ] [ " ] [ ' ] [ [ ] [ / ] [ ` ] [ ~ ] [ ! ] [ ; ]*/)|| l. isID()/*[id]*/)|| l. isNum()/*[num]*/){
        /*assert-production-closure*/
        /*
...
bool $class_declaration(Lexer l){
...
bool $method_definition(Lexer l){
    if( l. utf==42/*[asterisk]*/){
        /*peek-production-closure*/
        /*
...
bool $property_set_parameter_list(Lexer l){
    if( $binding_element( l)){
         prod = 88;
    }
     ;
...
bool $left_hand_side_expression(Lexer l){
...
bool $member_expression(Lexer l){
    if( cp2e37be7d_( l)/*[import]*/){
        /*assert-production-closure*/
        /*
...
bool $argument_list_group_1182_111(Lexer l){
...
bool $primary_expression(Lexer l){
    if( l. utf==40/*[(]*/){
        /*assert-production-closure*/
        /*
...
bool $assignment_expression(Lexer l){
...
bool $assignment_operator(Lexer l){
    if( assert_consume( l, l. utf==42/*[asterisk]*/)){
        /*consume*/
        /*
...
bool $conditional_expression(Lexer l){
...
bool $short_circuit_expression(Lexer l){
...
bool $logical_and_expression(Lexer l){
    if( $bitwise_or_expression( l)){
         prod = 113;
    }
     ;
...
bool $bitwise_or_expression(Lexer l){
    if( $bitwise_xor_expression( l)){
         prod = 117;
    }
     ;
...
bool $bitwise_xor_expression(Lexer l){
    if( $bitwise_and_expression( l)){
         prod = 118;
    }
     ;
...
bool $bitwise_and_expression(Lexer l){
    if( $equality_expression( l)){
         prod = 119;
    }
     ;
...
bool $equality_expression(Lexer l){
    if( $relational_expression( l)){
         prod = 120;
    }
     ;
...
bool $relational_expression(Lexer l){
    if( $shift_expression( l)){
         prod = 121;
    }
     ;
...
bool $additive_expression(Lexer l){
    if( $multiplicative_expression( l)){
         prod = 123;
    }
     ;
...
bool $multiplicative_expression(Lexer l){
    if( $exponentiation_expression( l)){
         prod = 124;
    }
     ;
...
bool $exponentiation_expression(Lexer l){
    if( $unary_expression( l)){
        /*assert*/
        /*
           378 exponentiation_expression=>• unary_expression 
...
bool $update_expression(Lexer l){
...
bool $cover_parenthesized_expression_and_arrow_parameter_list_group_1282_114(Lexer l){
    if( assert_consume( l, cp7fa4386a_( l)/*[...]*/)){
        /*consume*/
        /*
...
bool $cover_parenthesized_expression_and_arrow_parameter_list_group_1284_115(Lexer l){
    if( assert_consume( l, cp7fa4386a_( l)/*[...]*/)){
        /*consume*/
        /*
...
bool $cover_parenthesized_expression_and_arrow_parameter_list(Lexer l){
    if( l. utf==40/*[(]*/){
        /*peek*/
        /*
           396 cover_parenthesized_expression_and_arrow_parameter_list=>• ( ) 
...
bool $object_binding_pattern(Lexer l){
    if( assert_consume( l, l. utf==123/*[{]*/)){
        /*consume*/
        /*
...
bool $array_binding_pattern(Lexer l){
    if( assert_consume( l, l. utf==91/*[[]*/)){
        /*consume*/
        /*
...
bool $binding_rest_property(Lexer l){
    if( assert_consume( l, cp7fa4386a_( l)/*[...]*/)){
        /*consume*/
        /*
...
bool $binding_property_list(Lexer l){
...
bool $binding_element_list(Lexer l){
...
bool $binding_elision_element(Lexer l){
    if( l. utf==44/*[,]*/){
        /*assert-production-closure*/
        /*
...
bool $single_name_binding(Lexer l){
    if( $binding_identifier( l)){
        /*assert*/
        /*
           432 single_name_binding=>• binding_identifier initializer 
...
bool $binding_rest_element(Lexer l){
    if( assert_consume( l, cp7fa4386a_( l)/*[...]*/)){
        /*consume*/
        /*
...
bool $regular_expression_literal(Lexer l){
...
bool $property_definition_list(Lexer l){
...
bool $property_definition(Lexer l){
    if( assert_consume( l, cp7fa4386a_( l)/*[...]*/)){
        /*consume*/
        /*
...
bool $literal_property_name(Lexer l){
    if( l. isNum()/*[num]*/){
        /*assert-production-closure*/
        /*
...
bool $computed_property_name(Lexer l){
    if( assert_consume( l, l. utf==91/*[[]*/)){
        /*consume*/
        /*
           454 computed_property_name=>[ • assignment_expression ] 
...
bool $no_substitute_template(Lexer l){
    if( assert_consume( l, l. utf==96/*[`]*/)){
        /*consume*/
        /*
           475 no_substitute_template=>` • ` 
...
bool $substitute_template(Lexer l){
    if( $template_head( l)){
         skip_fn_( l/*[ ws ][ nl ]*/);
        if( $expression( l)){
             skip_fn_( l/*[ ws ][ nl ]*/);
...
bool $template_middle_list(Lexer l){
...
bool $binding_identifier(Lexer l){
    if( $identifier( l)){
         add_reduce(1,126);
         prod = 178;
    }
...
bool $future_reserved_word(Lexer l){
...
bool $composite_identifier(Lexer l){
...
bool $def$js_id_symbols(Lexer l){
    if( assert_consume( l, assert_table( l, 0x0, 0x10, 0x80000000, 0x0)/*tbl:[ $ ] [ _ ]*/|| l. isID()/*[id]*/)){
        /*consume*/
        /*
 ...
 bool main(string input_string){
     str =  input_string;
    const Lexer& l = new  Lexer();
     l. next();
